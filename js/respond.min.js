...
<html lang="en">
  ...
  <link crossorigin="anonymous" href="https://assets-cdn.github.com/assets/github-df65e463a55507b7351321962293ed86907555e4717f37920ec944c2a0541b05.css" integrity="sha256-32XkY6VVB7c1EyGWIpPthpB1VeRxfzeSDslEwqBUGwU=" media="all" rel="stylesheet" />
  ...
  <link rel="web-socket" href="wss://live.github.com/_sockets/VjI6MTYzODc4NzU5OjIzYTczNmVlMjg3MDM2NmJiOGNlYTU3ZmZiMGY1OGNkYjdjNDhmMTI4ODZkOTVhMzZjNzQxYmFkODk3N2Q4NTg=--bfcf4579955284633ff62668c970cff5a596cd39">
  <meta name="pjax-timeout" content="1000">
  <link rel="sudo-modal" href="/sessions/sudo_modal">
  <meta name="request-id" content="45EB:2C9D5:6AACFCE:9B5C4E6:58E29DCE" data-pjax-transient>
...
<meta content="collector.githubapp.com" name="octolytics-host" /><meta content="github" name="octolytics-app-id" /><meta content="https://collector.githubapp.com/github-external/browser_event" name="octolytics-event-url" /><meta content="45EB:2C9D5:6AACFCE:9B5C4E6:58E29DCE" name="octolytics-dimension-request_id" /><meta content="15920207" name="octolytics-actor-id" /><meta content="jfudge" name="octolytics-actor-login" /><meta content="60e418166e1ee88b682f44536e01d5b470495ba9dbf2f41d65cdf3c6d42c84b9" name="octolytics-actor-hash" />
<meta content="/&lt;user-name&gt;/&lt;repo-name&gt;/blob/show" data-pjax-transient="true" name="analytics-location" />
  ...
  <meta name="user-login" content="jfudge">

      <meta name="expected-hostname" content="github.com">
    <meta name="js-proxy-site-detection-payload" content="">


  <meta name="html-safe-nonce" content="e7fa4ef5d86e4feb34413e6e19d26f1421f7b525">

  <meta http-equiv="x-pjax-version" content="f7dab330d7fafcde2840ca65ecc11dcc">
...
<ul class="header-nav user-nav float-right" id="user-links">
  <li class="header-nav-item">
    ...
    <a href="/notifications" aria-label="You have no unread notifications" class="header-nav-link notification-indicator tooltipped tooltipped-s js-socket-channel js-notification-indicator " data-channel="notification-changed:15920207" data-ga-click="Header, go to notifications, icon:read" data-hotkey="g n">
...
<a class="dropdown-item" href="https://gist.github.com/" data-ga-click="Header, create new gist">
  ...
  <li class="header-nav-item dropdown js-menu-container">
    <a class="header-nav-link name tooltipped tooltipped-sw js-menu-target" href="/jfudge"
       aria-label="View profile and more"
       data-ga-click="Header, show menu, icon:avatar">
      <img alt="@jfudge" class="avatar" src="https://avatars3.githubusercontent.com/u/15920207?v=3&amp;s=40" height="20" width="20">
      <span class="dropdown-caret"></span>
    </a>
    ...
    <div class="dropdown-menu-content js-menu-content">
      <div class="dropdown-menu dropdown-menu-sw">
        <div class="dropdown-header header-nav-current-user css-truncate">
          Signed in as <strong class="css-truncate-target">jfudge</strong>
        </div>

        <div class="dropdown-divider"></div>

        <a class="dropdown-item" href="/jfudge" data-ga-click="Header, go to profile, text:your profile">
          Your profile
        </a>
        <a class="dropdown-item" href="/jfudge?tab=stars" data-ga-click="Header, go to starred repos, text:your stars">
          Your stars
        </a>
        ...
        <!-- '"` --><!-- </textarea></xmp> --></option></form><form accept-charset="UTF-8" action="/logout" class="logout-form" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="OjbR3WXkDrER2OklYX1ANiUy04jL/F/sDSqTP781+IcEf+vT2MaUNdw4mC2W757ZLzBuZh8o4L6iwvd+KXgRAQ==" /></div>
    ...
    <!-- '"` --><!-- </textarea></xmp> --></option></form><form accept-charset="UTF-8" action="/logout" class="sr-only right-0" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="GuVo4/oFap6CxluUeCusdmMKyee0twkiksyZ0/5qtpckrFLtRyfwGk8mKpyPuXKZaQh0CWBjtnA9JP2SaCdfEQ==" /></div>
      <button type="submit" class="dropdown-item dropdown-signout" data-ga-click="Header, sign out, icon:logout">
        Sign out
      </button>
</form>  </div>
  ...
  <li>
        <!-- '"` --><!-- </textarea></xmp> --></option></form><form accept-charset="UTF-8" action="/notifications/subscribe" class="js-social-container" data-autosubmit="true" data-remote="true" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="cX/3k7VqMBQcvaJYb2GtE4OyPRmQABqTTpFdgpjdModEGjgqRJvPG+UaFDT+f+DJDhbP4SCgeqkj0rlJ4x/9ug==" /></div>      <input class="form-control" id="repository_id" name="repository_id" type="hidden" value="1337658" />
  ...
  <li>
    ...
    <!-- '"` --><!-- </textarea></xmp> --></option></form><form accept-charset="UTF-8" action="/scottjehl/Respond/unstar" class="starred" data-remote="true" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="9VEWVx4Ftc2wRQPWIdfeYw7Nn22rqqKlNJZ+gCa9/HmUpRXdc9SuF/0WdOgSZQYCB/wkN0GqUYwfTTo8URPWRw==" /></div>
      <button
        type="submit"
        ...
        <a class="social-count js-social-count" href="/scottjehl/Respond/stargazers"
           aria-label="10775 users starred this repository">
          10,775
        </a>
</form>
    <!-- '"` --><!-- </textarea></xmp> --></option></form><form accept-charset="UTF-8" action="/scottjehl/Respond/star" class="unstarred" data-remote="true" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="xvMdLaU31XL1nUbSAX7nBcsZOH/aTsEDiqiDFYgXU5kn0ZHvwwmdKYd/zZAbtMHEFzJETdrtSgbWrhXQsxR0Rg==" /></div>
      <button
        type="submit"
        class="btn btn-sm btn-with-count js-toggler-target"
  ...
  <li>
          <!-- '"` --><!-- </textarea></xmp> --></option></form><form accept-charset="UTF-8" action="/scottjehl/Respond/fork" class="btn-with-count" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="1lGoH5d+wcaNBAylG9EbWLnRcf4gKOnYmW8OUE8X66JeojmicBL4374RKJHvO7LaFLrbCb9AsflF8h+CDi5HkQ==" /></div>
            <button
                type="submit"
    ...
    <a href="/scottjehl/Respond/network" class="social-count"
       aria-label="3593 users forked this repository">
      3,593
    </a>
  </li>
</ul>
...
<div class="select-menu branch-select-menu js-menu-container js-select-menu float-left">
  ...
  <div class="commit-tease">
    ...
    <a class="avatar-link tooltipped tooltipped-s" aria-label="SuriyaaKudoIsc" href="/scottjehl/Respond/commits/master/dest/respond.min.js?author=SuriyaaKudoIsc"><img alt="@SuriyaaKudoIsc" class="avatar" height="20" src="https://avatars3.githubusercontent.com/u/5073946?v=3&amp;s=40" width="20" /> </a>
...
<div class="file">
  ...
  <div class="file-actions">
    ...
    <div class="BtnGroup">
      ...
      <a href="/scottjehl/Respond/commits/master/dest/respond.min.js" class="btn btn-sm BtnGroup-item" rel="nofollow">History</a>
        ...
        <!-- '"` --><!-- </textarea></xmp> --></option></form><form accept-charset="UTF-8" action="/scottjehl/Respond/edit/master/dest/respond.min.js" class="inline-form js-update-url-with-hash" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="kc0Q/GNg1bJCLAxJi5V7lZiI8xwKHZLym0InRlggRzAWFnNafnNRpqzddWczYqffd2a/vp31QmX+U3/M1aUxJg==" /></div>
          <button class="btn-octicon tooltipped tooltipped-nw" type="submit"
            aria-label="Fork this project and edit the file" data-hotkey="e" data-disable-with>
            <svg aria-hidden="true" class="octicon octicon-pencil" height="16" version="1.1" viewBox="0 0 14 16" width="14"><path fill-rule="evenodd" d="M0 12v3h3l8-8-3-3-8 8zm3 2H1v-2h1v1h1v1zm10.3-9.3L12 6 9 3l1.3-1.3a.996.996 0 0 1 1.41 0l1.59 1.59c.39.39.39 1.02 0 1.41z"/></svg>
          </button>
</form>        <!-- '"` --><!-- </textarea></xmp> --></option></form><form accept-charset="UTF-8" action="/scottjehl/Respond/delete/master/dest/respond.min.js" class="inline-form" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="hQX/OuG/ZS64vI/XZZ9nAjszCS5FtKNM7KbiwknpYb8a+NXZxFLCJTx1dobSJP81S1XKE6FJGddg2lwh6EEJHA==" /></div>
  ...
  <div itemprop="text" class="blob-wrapper data type-javascript">
      ...
      <tr>
        ...
        <td id="LC4" class="blob-code blob-code-inner js-file-line"><span class="pl-c"> * https://j.mp/respondjs */</span></td>
      </tr>
      <tr>
...
<div id="jump-to-line" style="display:none">
  ...
  <div class="site-footer" role="contentinfo">
    ...
    <ul class="site-footer-links">
      <li>&copy; 2017 <span title="0.11277s from github-fe154-cp1-prd.iad.github.net">GitHub</span>, Inc.</li>
